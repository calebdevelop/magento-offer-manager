...
class ImageUploader
{
    ...
    {
        return rtrim((string)$path, '/') . '/' . ltrim($imageName, '/');
    }
    ...
    public function moveFileFromTmp($imageName)
    {
        ...
        $generatedFolder = substr(uniqid(), 0, 2);
        $basePath = rtrim($this->getBasePath(), '/') . '/' . $generatedFolder;
        ...
        return '/' . $generatedFolder . '/' . $imageName;
    }
